...
model_cfg = dict(
    ...
    query_num_queries=400,  # [q400 ablation] main run(200) 대비 query 수만 2배
...
visualization_cfg = dict(
    # ── 2D query_debug_vis ─────────────────────────────────────────────
    debug_query_vis_dir="./work_dirs/subset_attn_cover_pyr_aabb_dice3d_new_asset_all_filter_q400/query_debug_vis",
    debug_query_gaussian_vis_mode='prob',     # footprint 렌더 외형(prob heatmap)
    # ── cam_gaussian ───────────────────────────────────────────────────
    debug_query_cam_gaussian_vis_dir="./work_dirs/subset_attn_cover_pyr_aabb_dice3d_new_asset_all_filter_q400/query_cam_gaussian_vis",
    ...
    # ── 3D mixture3d ───────────────────────────────────────────────────
    debug_query_mixture3d_vis_dir="./work_dirs/subset_attn_cover_pyr_aabb_dice3d_new_asset_all_filter_q400/query_mixture3d_vis",
    ...
    debug_query_attn_softargmax_vis_dir=(
        "./work_dirs/subset_attn_cover_pyr_aabb_dice3d_new_asset_all_filter_q400/query_attn_softargmax_vis"
    ),
)
