...
visualization_cfg = dict(
    debug_query_vis_dir="./work_dirs/query_debug_vis_traj_bbox",
    ...
    debug_instance_img_vis_dir="./work_dirs/instance_img_debug_vis_traj_bbox",
    debug_instance_img_vis_max_frames=n_future_frames_plus,
    debug_query_cam_gaussian_vis_dir="./work_dirs/query_cam_gaussian_vis_traj_bbox",
    ...
    debug_gt_alignment_vis_dir="./work_dirs/gt_alignment_vis_traj_bbox",
    debug_query_inst_depth_lift_vis_dir="./work_dirs/query_inst_depth_lift_vis_traj_bbox",
    debug_query_inst_depth_lift_vis_max_frames=2,
    debug_query_inst_depth_lift_vis_max_instances=12,
    debug_query_attn_softargmax_vis_dir="./work_dirs/query_attn_softargmax_vis_traj_bbox",
    query_attn_vis_dir="./work_dirs/query_attn_vis_traj_bbox",
)
