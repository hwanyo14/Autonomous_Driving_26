...
def Smooth_L1_loss(pred, target, ignore_index=255):
    kept = (target[:, :, :, :, 0] != ignore_index) & (target[:, :, :, :, 1] != ignore_index)
...
def Smooth_L1_loss_for_height(pred, target, ignore_index=255):
    kept = (target[:, :, :, :, 0] != ignore_index)
...
def L1_loss_for_height(pred, target, ignore_index=255):
    kept = (target[:, :, :, :, 0] != ignore_index)
