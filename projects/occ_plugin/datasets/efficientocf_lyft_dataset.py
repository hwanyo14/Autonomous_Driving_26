...
class EfficientOCFLyftDataset(Dataset):
    def __init__(self, occ_size, pc_range, occ_root, idx_root, ori_data_root, data_root, time_receptive_field, n_future_frames, classes, use_separate_classes,
        ...
        '''
        EfficientOCFLyftDataset contains sequential occupancy states as well as instance flow for training occupancy forecasting models. We unify the related operations in the LiDAR coordinate system following OpenOccupancy.
        '''
        ...
        # training and test indexes following PowerBEV and Cam4DOcc
    ...
    def prepare_sequential_data(self, index):
        '''
        Use the predefined pipeline to generate inputs of the baseline network and ground truth for the standard evaluation protocol
        '''
        instance_map = {}
        input_seq_data = {}
