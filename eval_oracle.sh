...
CHECKPOINT=./work_dirs/subset_attn_cover_pyr_aabb_dice3d_new_asset_all_filter_q400/epoch_15_lss_only.pth
GPUS=8
export PORT=50091

# ----- 평가 동작 (baseline과 동일하게 맞춰 공정 비교) -----
export EOCF_EVAL_MODE=1            # 0=present / 1=future. baseline과 동일하게 future.
export EOCF_EVAL_OCC_THR=0.85      # baseline과 동일 occ threshold.
