...
CHECKPOINT=./work_dirs/full_attn_cover_pyr_aabb_dice3d_new_asset_all_filter/epoch_14_lss_only.pth
GPUS=8
export PORT=50632

# ----- 평가 동작 -----
export EOCF_EVAL_MODE=1            # 기준 프레임: 0=present(현재 1) / 1=future(미래 n_future). metric·viz 공통
export EOCF_EVAL_OCC_THR=0.7    # occ 점유 threshold. config eval_occ_threshold override
