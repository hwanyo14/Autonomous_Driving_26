...
CONFIG=projects/configs/baselines/shape_guide.py
CHECKPOINT=./work_dirs/shape_guide/latest.pth
GPUS=8
export PORT=20003

# ----- 평가 동작 -----
export EOCF_EVAL_MODE=1            # 기준 프레임: 0=present(현재 1) / 1=future(미래 n_future). metric·viz 공통
# export EOCF_EVAL_OCC_THR=0.5     # occ 점유 threshold. config eval_occ_threshold override
